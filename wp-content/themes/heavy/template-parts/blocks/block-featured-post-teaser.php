...
?>
<div class="teaser-row teaser--featured-post row-inside--md">
    <div class="teaser-row__container container">
        <div class="teaser-header row-y-inside--lg row-inside--md row-outside--md d-flex justify-content-between">
            <?php if(!empty($title)):?>
        ...
        <?php if(!empty($featured_post)):?>
            <?php foreach($featured_post as $post): setup_postdata($post);
                ...
                //$post_category will go here
            ?>
                <div class="teaser teaser--flex d-md-flex align-items-md-start">
                    <div class="teaser__col teaser__col--text col-md-5">
