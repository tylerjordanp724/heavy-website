...
function heavy_assets() {
	...
	wp_enqueue_script('waypoints', "https://cdnjs.cloudflare.com/ajax/libs/waypoints/2.0.3/waypoints.min.js", array(), false, true);
...
function heavy_portfolios() {
	...
	$labels = array(
		...
		'insert_into_item'      => __( 'Insert into item', 'text_domain' ),
		'uploaded_to_this_item' => __( 'Uploaded to this item', 'text_domain' ),
		'items_list'            => __( 'Portfolios', 'text_domain' ),
		'items_list_navigation' => __( 'Portfolios', 'text_domain' ),
		'filter_items_list'     => __( 'Filter Portfolios', 'text_domain' ),
	);
	$rewrite = array(
		'slug'                  => 'portfolio',
		'with_front'            => true,
	...
	$args = array(
		...
		'description'           => __( 'Heavy Portfolios', 'text_domain' ),
		'labels'                => $labels,
		'supports'              => array( 'title', 'editor', 'thumbnail', 'page-attributes', 'post-formats' ),
		'taxonomies'            => array( 'category', 'post_tag' ),
		'hierarchical'          => false,
...
add_action( 'init', 'heavy_portfolios', 0 );
